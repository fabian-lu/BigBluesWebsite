<template>
  <div class="section-main">
	<div class="bg-layer">
		<h1>Big Blues offizielles Vereinsportal</h1>
		<div class="header-main">
			<div class="main-icon">
				<img src="images/logo.jpeg" alt="Avatar" style="width:200px; border-radius: 50%;  margin-bottom: 20px;">
			</div>
			<div class="header-left-bottom">
				<form action="#" method="post">
					...
					<div class="bottom">
						<button class="btnLog">Einloggen</button>
					</div>
					<div class="bottom">
						<button class="btnGuest">Als Gast fortfahren</button>
					</div>
				</form>
			</div>
		</div>
...
.section-main{
    background-image: url('../../../storage/app/images/bg.jpg');
...
.header-left-bottom button.btnLog {
    background: #004696;
    color: #fff;
    font-size: 15px;
    text-transform: uppercase;
...
.header-left-bottom button.btnGuest {
    background: #ec1620;
    color: #fff;
    font-size: 15px;
    text-transform: uppercase;
